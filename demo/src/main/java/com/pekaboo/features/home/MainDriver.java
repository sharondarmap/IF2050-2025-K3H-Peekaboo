...
public class MainDriver extends Application {
    ...
    public void start(Stage primaryStage) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/pekaboo/home/Main.fxml"));
            Parent root = loader.load();
            Scene scene = new Scene(root, 1280, 720);
            loadStylesheet(scene, "/com/pekaboo/navbar/Navbar.css");
            loadStylesheet(scene, "/com/pekaboo/home/global-styles.css");
